...
public class SeleniumOperations {
	...
	public static void amazon_registration_page(String url) {
		...
		System.out.println("Found element: " + element);
		// Send first name
		element.sendKeys("Sandriya Fernandes");
		...
		//Find input field which is confirm password
		WebElement cfpassword = driver.findElement(By.id("ap_password_check"));
		System.out.println("Found element: " + element);
		// Send phone number
		cfpassword.sendKeys("Sa123");		
		...
		try {
	        // Save the screenshot to a file
	        FileUtils.copyFile(screenshotFile, new File("C:/Users/sandr/Downloads/screenshotsan1.png"));
	    } catch (Exception e) {
	        e.printStackTrace();
	    }
